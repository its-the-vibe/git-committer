...
[![CI](https://github.com/its-the-vibe/git-committer/actions/workflows/ci.yaml/badge.svg)](https://github.com/its-the-vibe/git-committer/actions/workflows/ci.yaml)
